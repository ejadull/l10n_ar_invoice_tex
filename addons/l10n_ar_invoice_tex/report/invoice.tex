...
%% INVOICE INFORMATION
	...
	\authorized{Comprobante${ (o.wsafip_cae and ' ') or ' No '}autorizado.}
	\cae{${o.wsafip_cae or '-'}}
	\caedue{${formatLang(o.wsafip_cae_due, date=True) or '-'}}
	<% barcode = "%s%02i%04i%014i%08i" % (
		...
		int(o.wsafip_cae or 0),
		int(o.wsafip_cae_due is not False and flatdate(o.wsafip_cae_due) or 0)
		) %>
