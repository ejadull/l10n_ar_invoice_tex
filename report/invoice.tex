...
%% INVOICE INFORMATION
	...
	%% Foot
	\subtotal{${formatLang(o.amount_untaxed if not is_class(o, 'BC') else o.amount_total)}}
	\vatamount{${formatLang(o.amount_tax)}}
	\taxamount{${formatLang(0)}}
	\total{${formatLang(o.amount_total)}}
...
% if not is_class(o, 'BC'):
  %for t in o.tax_line:
	\tax{${t.tax_code_id.name | tex}}{${formatLang(t.amount)}}
  % endfor
% endif
